"""
readme_creating.py
Generates a README.md file that previews the HTML guide for the Rotation Explorer.
"""

import pathlib

def build_readme() -> str:
    """Generates the content for a README.md file that previews the HTML guide."""
    return """# Rotation Explorer
...
def main() -> None:
    out = pathlib.Path(__file__).parent / "README.md"
    out.write_text(build_readme(), encoding="utf-8")
